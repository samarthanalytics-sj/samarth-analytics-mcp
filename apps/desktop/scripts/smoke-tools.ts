...
function makeFakeData(): { data: GoogleDataService; calls: string[]; mutations: () => number; ads: GoogleAdsService } {
  ...
  const data = {
    ...
    updateGtmEnvironment: (_a: string, _c: string, environmentId: string) => r('updateGtmEnvironment', { environmentId, name: 'Test', type: 'user', authorizationCode: 'A', url: '', snippet: { head: 'h', body: 'b' } }),
    ...
    updateGtmClient: (_a: string, _c: string, _w: string, clientId: string) => r('updateGtmClient', { clientId, name: 'GA4', type: 'gaaw_client' }),
    createGtmTransformation: () => r('createGtmTransformation', { transformationId: 'X1', name: 'X', type: 'sgtm_transformation' }),
    updateGtmTransformation: (_a: string, _c: string, _w: string, transformationId: string) => r('updateGtmTransformation', { transformationId, name: 'X', type: 'sgtm_transformation' }),
