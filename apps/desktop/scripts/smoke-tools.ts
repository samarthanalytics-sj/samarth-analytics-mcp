...
const MUTATIONS = new Set([
  ...
  'addGa4UserProperties', 'addGa4UserPropertiesToAllTags',
...
function makeFakeData(): { data: GoogleDataService; calls: string[]; mutations: () => number } {
  ...
  const data = {
    ...
    addGa4UserProperties: () => r('addGa4UserProperties', { tagId: 'TAG1', name: 'X', type: 'gaawe' }),
    addGa4UserPropertiesToAllTags: () => r('addGa4UserPropertiesToAllTags', { total: 1, updated: ['X'], failed: [] }),
