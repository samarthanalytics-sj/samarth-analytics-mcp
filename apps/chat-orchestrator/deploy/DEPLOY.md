...
- DNS: `chat.YOUR-DOMAIN.com` A record pointing at the server.
...
docker run --rm -p 80:80 \
  ...
  -d chat.YOUR-DOMAIN.com --agree-tos -m you@example.com --no-eff-email
```
...
```bash
curl -s https://chat.YOUR-DOMAIN.com/health | jq
```
...
**5. Point the website at it.** In Vercel, set `VITE_ORCHESTRATOR_URL=https://chat.YOUR-DOMAIN.com`
