...
export const GALLERY_CATEGORIES: { category: string; examples: string[]; known?: Record<string, string> }[] = [
  ...
  },
  {
    ...
    known: {
      ...
      'Stape Impact': 'stape-io/impact-tag',
      'Stape Rakuten': 'stape-io/rakuten-tag',
      'Stape ShareASale': 'stape-io/shareasale-tag',
      'Stape Tradedoubler': 'stape-io/tradedoubler-tag',
      'Stape Webgains': 'stape-io/webgains-tag',
      'Stape Admitad': 'stape-io/admitad-tag',
      'Stape Adtraction': 'stape-io/adtraction-tag',
