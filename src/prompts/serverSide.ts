...
function buildRecipe(a: { accountId?: string; containerName?: string; measurementId?: string; adsConversionId?: string }): string {
  ...
  return [
    ...
    '',
    '3. CREATE THE GA4 CLIENT — clients_create, which claims incoming GA4/gtag requests. Pass the resource below as a JSON STRING in the bodyJson argument (clients_create takes bodyJson, not structured fields):',
    '   bodyJson: \'{ "name":"GA4", "type":"gaaw_client", "parameter":[ {"type":"boolean","key":"activateDefaultPaths","value":"true"}, {"type":"boolean","key":"activateGtagSupport","value":"true"} ] }\'',
    '',
